...
export class NoiseGenerator {
  ...
  ridgedNoise(x: number, y: number, octaves = 4, persistence = 0.5, lacunarity = 2.0): number {
    let value = 0
    let amplitude = 1
    let frequency = 1
    let maxValue = 0
  ...
  getTerrainHeight(x: number, z: number, scale = 0.01): number {
  ...
  // Biome determination
  getBiome(x: number, z: number, scale = 0.005): string {
  ...
  // Cave generation
  isCave(x: number, y: number, z: number, scale = 0.02): boolean {
  ...
  fbm3D(x: number, y: number, z: number, octaves = 4, persistence = 0.5, lacunarity = 2.0): number {
    let value = 0
    let amplitude = 1
    let frequency = 1
    let maxValue = 0
